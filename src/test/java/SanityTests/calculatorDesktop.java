...
{
    //Preconditions - Open WinAppDriver.exe window must(Path - C:\Program Files(*86)\Windows Application Driver\WinAppDriver.exe), XML File - platformName change to "desktop"
